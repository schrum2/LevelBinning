...
public class GraphicsUtil {
	...
	public static final int PicbreederTask_CPPN_NUM_INPUTS = 4;
	public static final int PicbreederTask_CPPN_NUM_OUTPUTS = 3;
...
//				getDefaultScreenDevice().getDefaultConfiguration(); 
	...
	public static BufferedImage imageFromCPPN(Network n, int imageWidth, int imageHeight) {
		...
		return imageFromCPPN(n,imageWidth,imageHeight, ArrayUtil.doubleOnes(PicbreederTask_CPPN_NUM_INPUTS), -1);
	}
