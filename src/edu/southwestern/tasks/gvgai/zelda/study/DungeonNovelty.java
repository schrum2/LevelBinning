...
public class DungeonNovelty {
	...
	/**
	 * Find the novelty of a room (given by focus) with respect to all the other
	 * rooms of the list.
	 * This is essentially the average distance of the room from all other rooms.
	 * 
	 * @param rooms List of rooms to compare with. Could be List of Lists or
	 *              Dungeon.Nodes
	 * @param focus Index in rooms representing the room to compare the other rooms
	 *              with
	 * @return Real number between 0 and 1, 0 being non-novel and 1 being completely
	 *         novel
	 */
	...
	/**
	 * Version of the same method that takes an Integer List representation of the
	 * levels
	 * 
	 * @param room1 List of Lists representing a level
	 * @param room2 List of Lists representing a level
	 * @return Real number between 0 and 1, 0 being identical and 1 being completely
	 *         different
	 */
	...
	/**
	 * Get the novelty of a dungeon by computing average novelty of all rooms in the
	 * dungeon
	 ...
	 * 
	 * @param rooms List of rooms
	 * @return double array where each index is the novelty of the same index in the
	 *         rooms list.
	 */
	public static double[] roomNovelties(List<List<List<Integer>>> rooms) {
		...
		// The order of the rooms can be different each time the rooms are loaded. Put
	...
	/**
	 * Perform an analysis of the novelty of of various dungeons from the original
	 * game and
	 * from the human subject study conducted in 2019. Note that this command
	 * assumes the
	 * availability of saved dungeon data from the study, stored in the location
	 * specified
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		String[] names = new String[] { "tloz1_1_flip", "tloz2_1_flip", "tloz3_1_flip", "tloz4_1_flip", "tloz5_1_flip",
				"tloz6_1_flip", "tloz7_1_flip", "tloz8_1_flip", "tloz9_1_flip",
				"tloz1_2_flip", "tloz2_2_flip", "tloz3_2_flip", "tloz4_2_flip", "tloz5_2_flip", "tloz6_2_flip",
				"tloz7_2_flip", "tloz8_2_flip", "tloz9_2_flip" };
		...
		for (String name : names) {
			...
			List<List<List<Integer>>> roomList = ZeldaVGLCUtil
					.convertZeldaLevelFileVGLCtoListOfRooms(ZeldaVGLCUtil.ZELDA_LEVEL_PATH + file);
		...
		for (int i = 0; i < 30; i++) {
			String path = basePath + i + File.separator;
		...
		for (int i = 0; i < 30; i++) {
			...
			// Dungeon originalDungeon = Dungeon.loadFromJson(path +
			// "OriginalLoader_dungeon.json");
